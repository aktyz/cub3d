...
/*   Updated: 2025/08/19 17:42:58 by hhurnik          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
int	mlx_hook(void *win_ptr, int x_event, int x_mask, int (*funct_ptr)(),
		void *param);
...
17
	- event code for DestroyNotify triggered when the user clicks 
	the red close button on the window
0 - a mask that means "just listen to this specific event,
